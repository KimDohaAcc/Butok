...
<head>
    ...
    <link rel="stylesheet" href="css/mobileResultList.css">
    ...
    <div class="container">
        ...
        <section class="mapSection">
            <sec:authorize access="hasAuthority('USER')">
                ...
                <c:set var="checked" value="${param.checked.equals('checked')? 'checked' : ''}"/>
            </sec:authorize>
            <div id="sideBar">
                <div class="search">
                    <select id="rentType">
                        ...
                        <c:forEach items="${rentList}" var="deal">
                            <option ${param.rentType.equals(deal.dealRentType) ? 'selected' : ''}>${deal.dealRentType}</option>
                        </c:forEach>
                    </select>
                    <select id="apartmentType">
                        <option>전체</option>
                        <c:forEach items="${aptList}" var="deal">
                            <option ${param.aptType.equals(deal.dealApartmentType) ? 'selected' : ''}>${deal.dealApartmentType}</option>
                        </c:forEach>
                    </select>
